...
# Step 01: Provision Azure Function App + User-Assigned Managed Identity
#
# Prerequisites:
...
# --- Configuration ---
FUNC_RESOURCE_GROUP="${FUNC_RESOURCE_GROUP:-rg-agentid-func-demo}"
FUNC_APP_NAME="${FUNC_APP_NAME:-func-agentid-demo}"
FUNC_STORAGE_NAME="${FUNC_STORAGE_NAME:-stfuncagentid$(( RANDOM % 90000 + 10000 ))}"
FUNC_LOCATION="${FUNC_LOCATION:-centralus}"
MI_NAME="${MI_NAME:-mi-agentid-func}"

echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  PERSONA 1: Central AI Governance Team"
echo "  Provisioning Function App + Managed Identity"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
echo ""
echo "⚡ Creating Function App (Python 3.11)..."
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  ✅ Function App + MI provisioned"
echo ""
