...
#
# Prerequisites:
#   - .env with FUNC_RESOURCE_GROUP, AGENT_IDENTITY_ID
#
# Creates:
#   - Storage Account + blob container (for agent data writes)
...
STORAGE_ACCOUNT_NAME="${STORAGE_ACCOUNT_NAME:-stfuncagentdata$(( RANDOM % 90000 + 10000 ))}"
...
az storage account create \
  ...
  --location "${FUNC_LOCATION:-centralus}" \
  --sku Standard_LRS \
  --kind StorageV2 \
  --output none
...
echo ""
echo "  Next steps:"
echo "  1. Run 05-deploy-function.sh to deploy the function code"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
